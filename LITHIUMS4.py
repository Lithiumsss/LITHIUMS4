...
LINKS = [
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543465Pejqiws02hzi32upwkx5&balance=0&currency=USD&userid=14495534&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543467Plwgpeq96tsbesul6xe6&balance=0&currency=USD&userid=14495536&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543473Pkwfg1ywzm01lg5vxtpj&balance=0&currency=USD&userid=14495542&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543477P6hbso84j3b55n67kdhp&balance=0&currency=USD&userid=14495546&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543479Pz049o2iuus0pv1q8lhk&balance=0&currency=USD&userid=14495548&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543481Poz7a60qpkl9terv6ysg&balance=0&currency=USD&userid=14495550&isMobile=false",
    "https://casino.virtualsoft.tech/game/play/?gameid=203831&mode=real&provider=undefined&lan=es&partnerid=8&token=0P14543484Pmmphymo6fpomd105t3t&balance=0&currency=USD&userid=14495553&isMobile=false"
]
...
def abrir_y_verificar_tags_todos(dr):
    print("⏳ [LITHIUMS4 - HEADLESS] Abriendo y preparando todos los chats en segundo plano...")
    handles = []
...
def run():
    ...
    try:
        ...
        print(f"\n🚀 [LITHIUMS4 ACTIONS] INICIANDO RACHAS INTELIGENTES ({num_tags} chats activos)...")
            ...
            for idx in range(num_tags):
                ...
                if ahora >= proximo_disparo_por_tag[idx]:
                    ...
                    if disparar_con_protocolo_seguro(dr, handles[idx], idx, msg):
                        ...
                        print(f"    ⚡ [LITHIUMS4] Chat #{idx+1} enviado | Total ciclo: {total_disparos_global}/{MAX_DISPAROS_CICLO}")
        ...
        print(f"\n🎯 [LITHIUMS4] META DE {MAX_DISPAROS_CICLO} ALCANZADA.")
        
    except Exception as e:
        print(f"⚠️ [LITHIUMS4] Error en ejecución: {e}")
    finally:
        try: dr.quit()
        except: pass
        ...
        historial_enviados.clear()
        gc.collect()
        print("🔄 [LITHIUMS4] Ciclo finalizado correctamente en GitHub Actions.\n")
